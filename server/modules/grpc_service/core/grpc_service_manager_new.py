...
class NewGrpcServiceManager(UniversalModuleInterface):
    """
    ...
    def __init__(self, config: Optional[GrpcServiceConfig] = None):
        ...
        logger.info("New gRPC Service Manager created")
    ...
    async def initialize(self) -> bool:
        ...
        """
        try:
            logger.info("Initializing New gRPC Service Manager...")
            ...
            logger.info("New gRPC Service Manager initialized successfully")
            return True
            
        except Exception as e:
            logger.error(f"Failed to initialize New gRPC Service Manager: {e}")
            return False
    ...
    async def start(self) -> bool:
        """Запуск нового gRPC сервиса"""
        try:
            logger.info("Starting New gRPC Service Manager...")
            ...
            logger.info("New gRPC Service Manager started successfully")
            return True
            
        except Exception as e:
            logger.error(f"Error starting New gRPC Service Manager: {e}")
            return False
    
    async def stop(self) -> bool:
        """Остановка нового gRPC сервиса"""
        try:
            logger.info("Stopping New gRPC Service Manager...")
            ...
            logger.info("New gRPC Service Manager stopped successfully")
            return True
            
        except Exception as e:
            logger.error(f"Error stopping New gRPC Service Manager: {e}")
            return False
    
    async def process(self, input_data: Dict[str, Any]) -> AsyncGenerator[Dict[str, Any], None]:
        """
        Основная обработка данных через новый gRPC сервис
        ...
        try:
            ...
            logger.error(f"Error in New gRPC Service Manager process: {e}")
            yield {
                'success': False,
                'text_response': '',
                'audio_chunks': [],
    ...
    async def process_request(self, request_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        try:
            logger.info(f"🔄 Processing request through new architecture...")
    ...
    async def get_status(self) -> Dict[str, Any]:
        """
        Получение статуса нового gRPC сервиса
    ...
    async def cleanup(self):
        """Очистка ресурсов нового gRPC сервиса"""
        try:
            logger.info("Cleaning up New gRPC Service Manager...")
            ...
            logger.info("✅ New gRPC Service Manager cleaned up")
            
        except Exception as e:
            logger.error(f"❌ Error cleaning up New gRPC Service Manager: {e}")
