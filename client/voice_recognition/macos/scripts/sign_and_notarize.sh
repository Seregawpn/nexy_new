...
# Скрипт подписи и нотаризации voice_recognition для macOS
...
# Конфигурация
APP_NAME="Voice Recognition"
APP_PATH="dist/${APP_NAME}.app"
BUNDLE_ID="com.nexy.voice.recognition"
ENTITLEMENTS="entitlements/voice_recognition.entitlements"
...
# Основная функция
main() {
    log "Начинаем подпись и нотаризацию voice_recognition..."
