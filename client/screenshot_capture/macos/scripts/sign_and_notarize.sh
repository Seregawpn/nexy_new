...
# Скрипт подписи и нотаризации screenshot_capture для macOS
...
ENTITLEMENTS="entitlements/screenshot_capture.entitlements"
...
# Основная функция
main() {
    log "Начинаем подпись и нотаризацию screenshot_capture..."
