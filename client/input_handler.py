...
class InputHandler:
    ...
    def on_press(self, key):
        ...
        if key == keyboard.Key.space and not self.space_pressed:
            ...
            # 2. ОТПРАВЛЯЕМ ПРЕРЫВАНИЕ + СРАЗУ АКТИВАЦИЮ МИКРОФОНА
            ...
            # 3. СРАЗУ АКТИВИРУЕМ МИКРОФОН ДЛЯ ПРОСЛУШИВАНИЯ!
            ...
            console.print(f"[dim]🎤 Микрофон будет активирован СРАЗУ после прерывания![/dim]")
