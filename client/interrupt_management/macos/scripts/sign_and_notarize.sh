...
# Скрипт подписи и нотаризации interrupt_management для macOS
...
# Конфигурация
APP_NAME="Interrupt Management"
APP_PATH="dist/${APP_NAME}.app"
BUNDLE_ID="com.nexy.interrupt.management"
ENTITLEMENTS="entitlements/interrupt_management.entitlements"
...
# Основная функция
main() {
    log "Начинаем подпись и нотаризацию interrupt_management..."
